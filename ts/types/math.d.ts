...
declare namespace mathjs {
    ...
    export interface IMathJsStatic {
        ...
        // expression: MathNode;
        // Martijn Besamusca edit:
        // expression isn't a MathNode but will need math.expression.node.____Node

        expression: MathOptionsExpression;
    ...
    // EDIT MARTIJN BESAMUSCA
    export interface ConstantNode {
        new(value: any): MathNode;
    }
    export interface OperatorNode {
        new(op: string, fn: string, args: MathNode[]): MathNode;
    }
    export interface FunctionNode {
        new(fn: MathNode | string, args: MathNode[]): MathNode;
    }
    export interface SymbolNode {
        new(name: string): MathNode;
    }

    export interface MathOptionsNode {
    ...
    export interface MathOptionsExpression {
        node: MathOptionsNode;
    }

  ...
  <div id="settings">
    ...
    <app-input-panel title="window">
      <app-input-group title="view">
        <app-input-number
          label="x min"
          varName="viewbox.x.min"
          :store="this.$store"
          :max="this.$store.state.settings.viewbox.x.max - delta"
          :step="delta"
        />
        <app-input-number
          label="x max"
          varName="viewbox.x.max"
          :store="this.$store"
          :min="this.$store.state.settings.viewbox.x.min + delta"
          :step="delta"
        />
        <app-input-number
          label="y min"
          varName="viewbox.y.min"
          :store="this.$store"
          :max="this.$store.state.settings.viewbox.y.max - delta"
          :step="delta"
        />
        <app-input-number
          label="y max"
          varName="viewbox.y.max"
          :store="this.$store"
          :min="this.$store.state.settings.viewbox.y.min + delta"
          :step="delta"
        />
      </app-input-group>
      <app-input
        ...
        type="checkbox"
        varName="keepAspectRatio"
        :store="this.$store"
        :checked="this.$store.state.settings.keepAspectRatio"
      />
    </app-input-panel>
    <app-input-panel title="arrows">
      ...
      />
      <app-input
        label="Normalize speed"
        type="checkbox"
        varName="normalizeSpeed"
        :store="this.$store"
        :checked="this.$store.state.settings.normalizeSpeed"
      />
      <app-input-number
        label="Maximal age"
        varName="arrowMaxAge"
      ...
      />
      <app-input
        label="Random max age"
        type="checkbox"
        varName="arrowRandomizeMaxAge"
        :store="this.$store"
        :checked="this.$store.state.settings.arrowRandomizeMaxAge"
      />
      <app-input-number
        label="Size"
        varName="arrowSize"
      ...
      <app-input
        ...
        type="checkbox"
        varName="arrowRandomColor"
        :store="this.$store"
        :checked="this.$store.state.settings.arrowRandomColor"
      />
    ...
    <app-input-panel title="Solutions">
      ...
      <app-input-number
        label="Width"
        varName="solutionWidth"
        :store="this.$store"
        min="0"
      />
      <app-input
        label="Color"
        varName="solutionColor"
        type="color"
        :store="this.$store"
      />
    ...
    <app-input-panel title="Nullclines">
      ...
      <app-input-group title="x nullcline">
        <app-input
          label="enable"
          type="checkbox"
          varName="nullclineXEnable"
          :store="this.$store"
          :checked="this.$store.state.settings.nullclineXEnable"
        />
        <app-input
          label="color"
      ...
      <app-input-group title="y nullcline">
        <app-input
          label="enable"
          type="checkbox"
          varName="nullclineYEnable"
          :store="this.$store"
          :checked="this.$store.state.settings.nullclineYEnable"
        />
        <app-input
          label="color"
          varName="nullclineYColor"
          type="color"
          :store="this.$store"
        />
      </app-input-group>
